# <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExemFuZ2I0ZzdkYjF4cmtrazRrNHo0YTU2OGFwNnl5YXRrdDIyNzQ4byZlcD12MV9naWZzX3NlYXJjaCZjdD1n/bGgsc5mWoryfgKBx1u/giphy.gif" width="30px"> HolyG's Dev Portfolio
...
<div align="center" style="margin-bottom: 20px;">
  <a href="#about" style="margin: 0 10px; text-decoration: none;">
    <img src="https://img.shields.io/badge/ABOUT-8A2BE2?style=for-the-badge&logoColor=white" alt="About" />
  </a>
  <a href="#tech-stack" style="margin: 0 10px; text-decoration: none;">
    <img src="https://img.shields.io/badge/TECH_STACK-FF2D20?style=for-the-badge&logoColor=white" alt="Tech Stack" />
  </a>
  <a href="#projects" style="margin: 0 10px; text-decoration: none;">
    <img src="https://img.shields.io/badge/PROJECTS-38B2AC?style=for-the-badge&logoColor=white" alt="Projects" />
  </a>
  <a href="#stats" style="margin: 0 10px; text-decoration: none;">
    <img src="https://img.shields.io/badge/STATS-fc6f03?style=for-the-badge&logoColor=white" alt="Stats" />
  </a>
  <a href="#contact" style="margin: 0 10px; text-decoration: none;">
    <img src="https://img.shields.io/badge/CONTACT-777BB4?style=for-the-badge&logoColor=white" alt="Contact" />
  </a>
</div>
...
<section id="about">
  <div style="background-color: #0d1117; padding: 20px; border-radius: 10px; margin-bottom: 30px;">
    <h2 style="color: #FF2D20; border-bottom: 2px solid #FF2D20; padding-bottom: 10px;">⇱ About me</h2>
    <div align="center">
      ...
      <a href="#"><img src="https://img.shields.io/badge/☕_Coffee_→_Code-6F4E37?style=for-the-badge&logoColor=white&labelColor=6F4E37&color=6F4E37"/></a>
    </div>
...
<section id="projects">
  <div style="background-color: #0d1117; padding: 20px; border-radius: 10px; margin-bottom: 30px;">
    <h2 style="color: #fc6f03; border-bottom: 2px solid #fc6f03; padding-bottom: 10px;">Projects</h2>
    <div style="margin-bottom: 20px;">
      <h3 style="color: #FF2D20;">Live Projects</h3>
      <div align="center">
    ...
    <div style="margin-bottom: 20px;">
      <h3 style="color: #38B2AC;">GitHub Repositories</h3>
      <div align="center">
...
<section id="stats">
  <div style="background-color: #0d1117; padding: 20px; border-radius: 10px; margin-bottom: 30px;">
    <h2 style="color: #8A2BE2; border-bottom: 2px solid #8A2BE2; padding-bottom: 10px;">GitHub Statistics</h2> 
    <div align="center" style="margin-bottom: 20px;">
...
<section>
  <div style="background-color: #0d1117; padding: 20px; border-radius: 10px; margin-bottom: 30px;">
    <h2 style="color: #777BB4; border-bottom: 2px solid #777BB4; padding-bottom: 10px;">Inspiration</h2>
    <div align="center">
...
<section id="contact">
  <div style="background-color: #0d1117; padding: 20px; border-radius: 10px; margin-bottom: 30px;">
    <h2 style="color: #FF2D20; border-bottom: 2px solid #FF2D20; padding-bottom: 10px;">Contact</h2>
    <div align="center">
      ...
      &nbsp;&nbsp;
      <a href="mailto:devholyg@gmail.com">
...
<!-- Footer -->
<footer align="center" style="background-color: #0d1117; padding: 20px; border-radius: 10px; margin-top: 30px;">
<a href="#" style="text-decoration: none;">
  <img src="https://img.shields.io/badge/⬆️_Back_to_Top-8A2BE2?style=for-the-badge&logoColor=white" alt="Back to Top" />
</a>
    <p style="color: #8A2BE2; font-weight: bold;">© 2025 HolyG | Apprentice application developer</p>
</footer>
